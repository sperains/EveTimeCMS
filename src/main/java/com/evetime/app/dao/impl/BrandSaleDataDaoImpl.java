...
public class BrandSaleDataDaoImpl implements BrandSaleDateDao {
    ...
    public List<Map<String, Object>> querySaleOfWeek(String userId) {
        ...
        String sql =  " SELECT SUM(b.PayMoney) sale , DATE_FORMAT(a.OrderTime,'%m-%d') date FROM ms_pc_orderinfo a " +
                " JOIN ms_pc_orderpayinfo b ON a.Id = b.OrderId AND a.OrderStatusId = 0 " +
    ...
    public List<Branch> queryCurWeekBranchList(String userId) {
        ...
        String sql =  " SELECT a.CloudId , a.BranchName , m.sale FROM ms_web_companyuserrole r " +
                            ...
                            " LEFT JOIN ( " +
                            " SELECT a.CloudId , a.OrderTime , SUM(b.PayMoney) sale FROM ms_pc_orderinfo a JOIN ms_pc_orderpayinfo b ON a.Id = b.OrderId AND a.OrderStatusId = 0 " +
    ...
    public double queryCurDaySale(String userId) {
        ...
        String sql =  " SELECT SUM(b.PayMoney) todaySale FROM ms_pc_orderinfo a " +
